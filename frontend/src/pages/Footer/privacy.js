...
function Privacy() {
  return (
    <div className="container mx-auto p-8">
        ...
        <p className="text-gray-700 mb-4">Effective Date: October 26, 2023</p>

        <h2 className="text-2xl font-semibold mb-2">Information We Collect</h2>
        <p className="text-gray-700 mb-4">We collect several types of information from and about users of our Website, including information:</p>
        ...
        <p className="text-gray-700 mb-4">You have the following choices regarding your personal information:</p>
        <ul className="list-disc pl-6 text-gray-700 mb-4">
        ...
        <p className="text-gray-700">If you have any questions about this Privacy Policy, please contact us at: <a href="mailto:info@example.com" className="text-blue-500 hover:underline">info@example.com</a></p>
    </div>
  )
  }

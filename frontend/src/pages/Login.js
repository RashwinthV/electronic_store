...
const Login=() => {
    ...
    const handleSocialLogin = (provider) => {
        // Call the backend with the provider dynamically
        const backendSocialLoginUrl = `http://localhost:8000/login/${provider}`;
        window.location.href = backendSocialLoginUrl; // Redirect to backend which handles social login
      };
